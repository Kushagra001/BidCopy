...
5. humanizer        — remove AI writing patterns and signatures
```
...
### Step 5 — humanizer (blader/humanizer)
...
Register with:
- `capabilities: ["humanize_text", "detect_ai_writing", "calibrate_voice"]`
- `tags: ["writing", "editing", "quality"]`
- `invoke: "/humanize [text|file]"`
...
```
✓ Bootstrap complete: impeccable · caveman · design-extract · browser-harness · humanizer
...
| **humanizer** | Remove AI writing patterns and signatures | `/humanize [text|file]` |
