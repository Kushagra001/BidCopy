        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-lg text-[--color-bc-muted] leading-relaxed">
              Generate a personalised, winning Upwork proposal in 30 seconds. BidCopy knows Upwork&apos;s rules — proposals are kept under 450 words, strip markdown, and end with a question to encourage replies.
            </p>
          </div>
          ...
          <div className="text-[--color-bc-ink-2] text-lg leading-relaxed space-y-6 [&>h2]:text-2xl [&>h2]:font-bold [&>h2]:text-[--color-bc-ink] [&>h2]:mt-12 [&>h2]:mb-4 [&>ul]:list-disc [&>ul]:pl-6 [&>ul>li]:mb-2 [&>strong]:text-[--color-bc-ink]">
            ...
            <p>Notice how it names a specific result, references a project, and ties it directly to the client&apos;s pain point. BidCopy generates this level of specificity using your profile.</p>
            ...
            <ul>
              ...
              <li><strong>Generic template language</strong> — &quot;As per your requirements&quot; signals a copy-paste job</li>
            </ul>
          </div>
        </div>
      </main>
